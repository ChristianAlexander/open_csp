defmodule OpenCspWeb.Plug.Parsers.CspReport do
  @moduledoc """
  From Plug standard library, adapted for use with CSP reports, which may not have a json mime type.
  ...
  def parse(conn, "application", subtype, _headers, {{mod, fun, args}, decoder, opts}) do
    if subtype == "json" or String.ends_with?(subtype, "+json") or subtype == "csp-report" do
