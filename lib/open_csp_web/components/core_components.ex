defmodule OpenCspWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenCspWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenCspWeb.Gettext, "errors", msg, opts)
    end
  end
